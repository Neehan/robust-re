...
parser.add_argument("--model_dir", type=str, help="Directory of the biased model.")
parser.add_argument(
...
parser.add_argument("--save_dir", type=str, default="./debiased_saved_models", help="Root dir for saving models.")
...
def train_unbiased_model(args, biased_batch_probs):
	...
	for epoch in range(1, opt["num_epoch"] + 1):
	    ...
	    for i, batch in enumerate(train_batch):
	        ...
	        global_step += 1
	        loss = model.update(batch, torch.tensor(biased_batch_probs[i]).cuda())
	        train_loss += loss
...
biased_batch_probs = get_biased_model_class_probs(args)
train_unbiased_model(args, biased_batch_probs)
